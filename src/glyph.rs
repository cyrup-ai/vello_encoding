...
pub struct GlyphRun {
    ...
    /// Optional reference to glyphon buffer for proper text layout and positioning.
    /// This contains the shaped text with accurate glyph positions and metrics.
    pub buffer: Option<std::sync::Arc<glyphon::Buffer>>,
}
